...
The full legal code is available at: https://creativecommons.org

--------------------------------------------------------------------------------
【中文版】

本仓库内的所有文章及文字内容均采用“知识共享署名-非商业性使用 4.0 国际许可协议”（CC BY-NC 4.0）进行许可。
...
完整的法律条文请参阅：https://creativecommons.org
